...
public class CriticalShrapnelBulletType extends ShrapnelBulletType implements Critical {
    ...
    public void init(Bullet b) {
        super.init(b);
        Damage2.criticalCollideLaser(b, length, hitLarge, laserAbsorb, pierceCap, trueCritical());
    }
